    ...
    <main className="shell py-10 sm:py-16">
      ...
      <section className="glass card max-w-5xl p-6 sm:p-10">
        ...
        <div className="mt-9 grid gap-4 md:grid-cols-3">
          <article className="rounded-3xl border border-white/[0.08] bg-white/[0.025] p-5"><Archive size={20} className="text-sky-300"/><h2 className="mt-4 font-bold">منابع و آرشیو</h2><p className="micro mt-2">منبع فعال، صفحات عمومی Fundbase با انتساب Investats است؛ adapterهای مستقیم Fipiran و TSETMC نیز حفظ شده‌اند. snapshot و تاریخچه در فایل‌های versioned گیت نگهداری می‌شوند و دیتابیس لازم نیست.</p></article>
        ...
        <div className="mt-9 space-y-7 text-sm leading-8 text-white/65">
          <section><h2 className="text-xl font-bold text-white">به‌روزرسانی و تاریخچه</h2><p className="mt-2">Workflow گیت‌هاب پس از پایان بازار crawler و quality gate را اجرا می‌کند و در صورت پذیرش، آخرین JSON/CSV و manifest را commit می‌کند. آخرین مشاهده معتبر هر روز در پارتیشن سالانه صندوق‌ها قرار می‌گیرد و سری عمومی جریان پول Fundbase در نخستین اجرا backfill می‌شود.</p></section>
